...
const StepsForm = (props: StepsFormProps) => {
  const {
    ...
    ResultRender = DefaultCompleteRender, resultTitle, resultSubTitle, showResultReset, resultActions, resultResetText, resultResetProps, onResultReset, resultContent,
    stepContentProps,
    direction = 'horizontal', orientation, alternativeLabel, labelPlacement = 'horizontal', depend,
      ...
      <FormProvider form={form}>
        ...
        >
          {Children.map(children, (child, index) => {
            ...
            // @ts-ignore
            const { title, subTitle, icon = StepIcon, onFinish: onFinishProp, name, showReset: showResetProp, onReset } = child?.props || {};
...
export {
  ...
  type StepFormProps,
  type StepIconProps,
  type StepsFormResultRenderProps,
};
